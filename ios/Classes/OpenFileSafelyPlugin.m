#import "OpenFileSafelyPlugin.h"


@interface OpenFileSafelyPlugin ()<UIDocumentInteractionControllerDelegate>
@end

static NSString *const CHANNEL_NAME = @"open_file_safe";

@implementation OpenFileSafelyPlugin{
...
+ (void)registerWithRegistrar:(NSObject<FlutterPluginRegistrar>*)registrar {
    ...
    OpenFileSafelyPlugin* instance = [[OpenFileSafelyPlugin alloc] initWithViewController:viewController];
